def lookup(input_string):
    ...
    # put your event GUID here manually, for now
    event_guid = 'b8ede34f-aaa4-43c5-b81f-106d0e4215fe'
    contact_list = []

     # get all the contacts where 'input_string' matches part of a filter field, up to 20 results
    payload = {
    ...
    if result['ResponseCode'] !=200:
        ...
        # pass your list to the 'search.html' template to display it
            ...
            return render_template('lookup_list.html', event_guid=event_guid, input_string=input_string, contact_list=contact_list)